...
public class Robot extends IterativeRobot {
	...
	public void robotInit() {
		...
		drive = new Drive(RobotMap.leftFront, RobotMap.leftBack,  RobotMap.rightFront, RobotMap.rightBack);
		elevator = new Elevator(RobotMap.elevator1, RobotMap.elevator2);
